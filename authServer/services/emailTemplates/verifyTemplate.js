const keys = require('../../config/keys')
    ...
    {/* <html>
        <body>
           ...
           <p>
               Account Verification Token', text: 'Hello,\n\n' + 'Please verify your account by clicking the link: \nhttp:\/\/${data.host}\/confirmation\/${data.token}.\n'
           </p>
            </div>
        </body>
    </html> */}
module.exports = ({actionUrl,userName}) => {
    return `
              ...
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell">
                    <h1>Hi ${userName}, Welcome to Hichef!</h1>
                    <h2>to activate your profile please Verify your email address</h2>
                      ...
                      <tr>
                        <td align="center">
                          <div>
                            ...
                            <a href="${actionUrl}" class="button button--green" style="color:#ffffff;">Verify Email</a>
                          </div>
                        </td>
                      </tr>
                    </table>
